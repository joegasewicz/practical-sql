...
-- MAX() MIN()
SELECT visits FROM pls_fy2014_pupld14a;

-- GROUP BY
    -- On it's own it works similar to the DISTINCT keyword - eliminates duplicates
    -- Order BY - lost in alphabetical order
SELECT city, stabr
-- SELECT DISTINCT stabr -- (with distinct)
FROM pls_fy2014_pupld14a
GROUP BY city, stabr -- eliminate duplicates
ORDER BY city, stabr; -- list alphabetically
